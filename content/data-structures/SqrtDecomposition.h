 ...
 * License: CC0
 * Source: folklore
 * Description: Sqrt decomposition over a static-size array split into blocks of size BLOCK\_SIZE (must be defined externally, ~= sqrt N). Point update and range-sum query. Favors update-heavy workloads over query-heavy ones.
